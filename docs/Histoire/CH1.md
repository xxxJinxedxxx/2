...
![Croquis d'une cité grecque ]({A4B2BA16-6A98-40DA-8C43-05031F9C3AFB}.png)
...
```mermaid
flowchart TD
    A["Le sénat : Discutent des lois, grande autorité<br>Composé de 300 ancien magistrats"] 
    B["Les magistrats : <br> - 2 consuls qui dirigent Rome et l'armée<br>- 2 préteurs qui rendent la justice<br>-4 Ediles administrent la ville de Rome<br>- 10 Questeurs s'occupent des finances<br>- 10 Tribuns de la plèbe représentent les pauvres"]
    C["Les comices : Assemblé de citoyens riches<br> -votent les lois <br> -Elisent les magistrats <br> -Les patriciens"]
    D["Les citoyens pauvres : Plébiens<br> Pas le droit de vote ou d'être élu"]
    A -->|Contrôle| B
    B -->|Recrutent les sénateurs| A 
    C -->|Élisent| B
```
...
graph TD
    A["L'empereur"] 
    B["Chef de la religion (Grand pontife)"]
    C["Chef de l'armée (Imperator)"]
    D["Puissance Tributienne <br>(droit de veto, caractère sacré ed sa personne)"]
    E["Les magistrats<br>(Gouvernent Rome)"]
    F["Le sénat (ancien magistrats nommé à vie)"]
    A --> B
    A --> C
    A --> D
    A --> |Consul à vie<br>Dirige|E
    A --> |Préside le sénat en tant que Princeps|F
```
